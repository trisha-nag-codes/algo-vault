...
const PROBLEMS = {
  ...
  nqueens: {
    ...
    coreIdea: "Place one queen per row. For each row, try every column — skip if the column, main diagonal (row−col), or anti-diagonal (row+col) is already occupied. If all columns conflict, backtrack to the previous row and try the next column there. This constraint propagation prunes the 4⁴ search space dramatically.",
  },
  sudoku: {
    title: "Sudoku (4×4)",
